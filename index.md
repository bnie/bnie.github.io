...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
     <div class="content">
         <div class="details_header">
            <ul>
                 <li><a href="#pub"><span class="glyphicon glyphicon-link" aria-hidden="true"></span>Publications</a></li>
                 <li><a href="#proj"><span class="glyphicon glyphicon-link" aria-hidden="true"></span>Projects</a></li>
                 <li><a href="#awd"><span class="glyphicon glyphicon-link" aria-hidden="true"></span>Awards</a></li>
            </ul>
         </div>
         ...
         <!--
         <div class="company">
             <h3 class="clr0">Research Interests</h3>
             <div class="company_details">
                 <p>Heterogeneous System Log Analytics, GPU Reliability in High-Performance Computing, Workload Characterization, Performance Advertising, Online Social Networking and Recommender System.</p>
            </div>
         </div>
         -->
         ...
         <div class="skills">
             ...
             <div class="skill_list">
                     <ul>                   
                        ...
                        <li>CSCI426 Simulation <tab3/> --- <tab3/> Fall 2015</li>
                        <li>CSCI141 Computational Problem Solving in Python <tab3/> --- <tab3/> Fall 2014, Spring 2015</li>
                     </ul>
                 <div class="clearfix"></div>
             </div>
         </div>
         ...
         <div class="copywrite">
             <p>Last updated in August, 2018</p>
         </div>
     </div>
</div>
<!---->
